...
if gen == 'pgun':
    ...
    jetA = cms.vint32(211, -211, 22, 22, 130)
...
process.o1 = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('fastsim_AOD.root')
)

process.o2 = cms.OutputModule("PoolOutputModule",
    process.RECOSIMEventContent,
    fileName = cms.untracked.string('fastsim_RECO.root')
)
